...
def clearregisters():
    global registers
    registervalue1.set("0: " + str(0))
    registervalue2.set("1: " + str(0))
    registervalue3.set("2: " + str(0))
    registervalue4.set("3: " + str(0))
    registervalue5.set("4: " + str(0))
    registervalue6.set("5: " + str(0))
    registers = [0,0,0,0,0,0]

def clearmemory():
    global memory
    memoryvalue1.set("0: " + str(0))
    memoryvalue2.set("1: " + str(0))
    memoryvalue3.set("2: " + str(0))
    memoryvalue4.set("3: " + str(0))
    memoryvalue5.set("4: " + str(0))
    memoryvalue6.set("5: " + str(0))
    memoryvalue7.set("6: " + str(0))
    memoryvalue8.set("7: " + str(0))
...
def startprogram():
    ...
    while x < len(instructions):
        if instructions[x] == "0000":
            ...
            listbox2.insert('end',"Executing " + str(x+1) + ": " + instructions[x] + "\n")
            command = instructions[x+1]
            storefrom = decodebinary(command)
            command = instructions[x+2]
            storeto = decodebinary(command)
            memory[storeto] = registers[storefrom]
            x += 3
...
#Guide text
tk.Label(app,text="Guide:",bg='grey25',fg='snow').place(x=550,y=5)

tk.Label(app,text="0000",bg='grey25',fg='snow').place(x=550,y=25)
tk.Label(app,text="Function: Sets memory values.",bg='grey25',fg='snow').place(x=550,y=45)
tk.Label(app,text="Usage: Enter 0000, followed by the binary data followed by the binary address of the desired memory cell.",bg='grey25',fg='snow').place(x=550,y=65)

tk.Label(app,text="0001",bg='grey25',fg='snow').place(x=550,y=95)
tk.Label(app,text="Function: Loads a value from memory to a register.",bg='grey25',fg='snow').place(x=550,y=115)
tk.Label(app,text="Usage: Enter 0001, followed by the binary address of the data in memory followed by the binary address of the desired register.",bg='grey25',fg='snow').place(x=550,y=135)

tk.Label(app,text="0010",bg='grey25',fg='snow').place(x=550,y=165)
tk.Label(app,text="Function: Stores the data in a register into memory.",bg='grey25',fg='snow').place(x=550,y=185)
tk.Label(app,text="Usage: Enter 0011, enter the register number to be stored, then the address of the memory where the data will be stored.",bg='grey25',fg='snow').place(x=550,y=205)

tk.Label(app,text="0011",bg='grey25',fg='snow').place(x=550,y=235)
tk.Label(app,text="Function: Adds two registers.",bg='grey25',fg='snow').place(x=550,y=255)
tk.Label(app,text="Usage: Enter 0010, then the register number containing the first number, then the register number containing the second number.",bg='grey25',fg='snow').place(x=550,y=275)

tk.Label(app,text="0100",bg='grey25',fg='snow').place(x=550,y=305)
tk.Label(app,text="Function: Subtracts two registers.",bg='grey25',fg='snow').place(x=550,y=325)
tk.Label(app,text="Usage: Enter 0100, then the register number containing the first number, then the register number containing the second number.",bg='grey25',fg='snow').place(x=550,y=345)

tk.Label(app,text="0101",bg='grey25',fg='snow').place(x=550,y=375)
tk.Label(app,text="Function: Multiplies two registers.",bg='grey25',fg='snow').place(x=550,y=395)
tk.Label(app,text="Usage: Enter 0101, then the register number containing the first number, then the register number containing the second number.",bg='grey25',fg='snow').place(x=550,y=415)

tk.Label(app,text="0110",bg='grey25',fg='snow').place(x=550,y=445)
tk.Label(app,text="Function: Divides two registers.",bg='grey25',fg='snow').place(x=550,y=465)
tk.Label(app,text="Usage: Enter 0110, then the register number containing the first number, then the register number containing the second number.",bg='grey25',fg='snow').place(x=550,y=485)
...
#buttons
button1 = tk.Button(app,text="Add Instruction",bg='grey40',command=changelabelvalue).place(x=10,y=310,width=150)
...
button4 = tk.Button(app,text="Clear Previous",bg='grey40',command=clearprevious).place(x=10,y=370,width = 150)
button5 = tk.Button(app,text='Clear Output',bg='grey40',command=clearoutput).place(x=170,y=340,width=150)
button6 = tk.Button(app,text='Clear Prev Output',bg='grey40',command=clearprevoutput).place(x=170,y=370,width=150)
button7 = tk.Button(app,text='Clear Registers',bg='grey40',command=clearregisters).place(x=330,y=310,width=100)
button8 = tk.Button(app,text='Clear Memory',bg='grey40',command=clearmemory).place(x=440,y=310,width=100)
